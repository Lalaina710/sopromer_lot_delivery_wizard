...
class SopromerLotDeliveryWizard(models.TransientModel):
    ...
    def _build_available_lines(self, move):
        """Build (0,0,{}) commands for lots at move.location_id, with
        reservation info and FIFO pre-tick up to the demand quantity.
        """
    ...
    def action_validate(self):
        ...
        # Remove empty placeholder move lines before creating ours
        ...
        for av in to_deliver:
            take = min(av.qty_to_take, av.qty_free)
